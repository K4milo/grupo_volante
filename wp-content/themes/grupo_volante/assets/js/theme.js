...
(function ($) {
	...
	var $MapScope = {
		...
		mapScripts: function mapScripts() {
			...
			var markerItem = L.marker([4.7171484, -74.030713], { icon: div_circle }).addTo(map).bindPopup('<h3>Carrera 7 C Bis # 139-18</h3><p>Oficina 806 Bogotá – Colombia</p>').openPopup();
